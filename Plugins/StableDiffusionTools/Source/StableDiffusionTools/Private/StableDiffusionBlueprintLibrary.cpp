...
{
	if (const auto EditorClient = UStableDiffusionBlueprintLibrary::GetEditorClient())
	{
		EditorClient->RemoveRealtimeOverride(FText::FromString("Stable Diffusion Tools"));
	}
}
