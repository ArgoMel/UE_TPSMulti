...
void UAsyncTaskDownloadModel::Start(FString URL)
{
	...
	HttpRequest->OnRequestProgress64().BindUObject(this, &UAsyncTaskDownloadModel::HandleHTTPProgress);
...
void UAsyncTaskDownloadModel::HandleHTTPProgress(FHttpRequestPtr Request, uint64 TotalBytesWritten, uint64 BytesWrittenSinceLastUpdate)
{
